        ...
        <dialog ref={dialogRef} className="rounded-lg shadow-xl bg-white w-full max-w-md p-0 backdrop:bg-black/60">
            <div className='relative flex flex-col items-center p-8 sm:p-12'>
                ...
                <form className="w-full flex flex-col gap-4">
                    ...
                    <button type="submit" className="w-full bg-green-700 text-white py-2.5 rounded-md hover:bg-green-800 transition-colors mt-2">Login</button>
                </form>

                <p className="text-center text-sm text-gray-600 mt-6">
                    Don't have an account?{' '}
                    <button onClick={() => { handleClose(); switchToSignup(); }} className="text-green-600 font-semibold hover:underline">
                        Sign Up
                    </button>
                </p>
            </div>
